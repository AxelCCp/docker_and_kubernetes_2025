...
public class UsuarioController {
	...
	public ResponseEntity<?>listar(){
		...
		map.put("usuarios", usuarioService.listar());
		map.put("podinfo", environment.getProperty("MY_POD_NAME") + " : " + environment.getProperty("MY_POD_IP"));
		map.put("texto", environment.getProperty("config.texto"));
